...
export const Sale = () => {
  ...
  return (
    <div className="min-h-screen bg-[#2a2a2a] pt-40 pb-20">
      ...
      {/* Horizontal Scrollable Product Gallery - Matching NewArrivals */}
              ...
              >
                ...
                <div className="bg-[#f5f5f5] rounded-none group h-full w-full">
                  <div className="relative overflow-hidden bg-gray-200 w-full" style={{ aspectRatio: '3/4' }}>
                    ...
                    />
                    {/* Discount percentage on hover - top left */}
                    {hoveredProduct === product.id && product.onSale && (
                      <motion.div
      ...
      {/* Additional sections with all sale products */}
      <motion.div
        initial={{ opacity: 0 }}
